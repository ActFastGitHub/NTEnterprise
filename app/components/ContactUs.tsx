			...
			<div className='container mx-auto px-6 max-w-2xl text-center'>
				...
				{tab === "contact" && (
					<motion.div
						...
						<a
							href='tel:7787692471'
							className='bg-white shadow-md rounded-xl p-5 text-left hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 border border-transparent hover:border-emerald-200'>
						...
						<a
							href='mailto:info@ntenterprise.ca'
							className='bg-white shadow-md rounded-xl p-5 text-left hover:shadow-lg hover:-translate-y-0.5 transition-all duration-300 border border-transparent hover:border-emerald-200'>
							<div className='flex items-start gap-4'>
								<div className='bg-emerald-100 text-emerald-600 p-3 rounded-full'>
									<FaEnvelope size={18} />
