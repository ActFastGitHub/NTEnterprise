...
export type Property = {
  ...
  imageCount?: number;      // no longer used by the gallery, but harmless if present
  mapEmbedUrl?: string;
};
...
export const PROPERTIES: Property[] = [
  {
    slug: "Fraser-Highway",
    name: "Fraser-Highway",
    address: "15848 Fraser Hwy, Surrey, BC V4N 6X6",
    ...
    nightlyPrice: 270,  // ← edit per property anytime
  ...
  },
  {
    slug: "162-A",
    name: "162-A",
    address: "9678 162 A St, Surrey, BC V4N 2E4",
